...
let jsSHA = (function (Y) {
  function C(c, a, b) {
    ...
    if ('SHA-1' === c)
      ...
      0 === c.lastIndexOf('SHA3-', 0) ||
      0 === c.lastIndexOf('SHAKE', 0)
    ) {
      var F = 6
      q = D
      r = function (a) {
  ...
  function S(c, a) {
    return 32 < a
      ? ((a -= 32),
        new b((c.b << a) | (c.a >>> (32 - a)), (c.a << a) | (c.b >>> (32 - a))))
      : 0 !== a
  ...
  function ca(c, a, k) {
    return new b(
      (c.a & a.a) ^ (c.a & k.a) ^ (a.a & k.a),
      (c.b & a.b) ^ (c.b & k.b) ^ (a.b & k.b)
    )
  }
  function da(c) {
  ...
  function na(c, a, d, e) {
    ...
    h =
      (c.a & 65535) + (a.a & 65535) + (d.a & 65535) + (e.a & 65535) + (n >>> 16)
  ...
  function K(c, a) {
    ...
    for (f = 0; 80 > f; f += 1)
      (b[f] =
        16 > f ? c[f] : y(b[f - 3] ^ b[f - 8] ^ b[f - 14] ^ b[f - 16], 1)),
        (p =
          20 > f
            ...
            : H(y(e, 5), d ^ n ^ g, l, 3395469782, b[f])),
        (l = g),
        (g = n),
        (n = y(d, 30)),
        (d = e),
